...
const UserProfileDropdown = ({ firstName = '', lastName = '', email = '', username = 'Customer', avatarUrl = '', userRole = 'user' }) => {
  ...
  const handleAccountSettings = () => {
    ...
    alert('Account Settings - To be implemented');
    setIsOpen(false);
  };

  const handleSecurity = () => {
    // TODO: Navigate to security settings (change password, 2FA, etc.)
    alert('Security Settings - To be implemented');
    setIsOpen(false);
  };
  ...
  const handleHelp = () => {
    ...
    alert('Help & Support - To be implemented');
    setIsOpen(false);
  };
      ...
      {isOpen && (
        <div className="user-dropdown-menu">
          ...
          <div className="dropdown-section">
            ...
            <button className="dropdown-item" onClick={handleSecurity}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button className="dropdown-item dropdown-item-toggle" onClick={toggleDarkMode}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                {isDarkMode ? (
